...
$db = new mysqli("127.0.0.1", "traindbusr", "QMy2cwUWUh", "wordpress");
...
$query = 'select * from isdcwp_users'." where user_login = '".$userid."'";
$result = $db->query($query);

if($result->num_rows > 0)
{
	$row = $result->fetch_assoc();
	$userpasswd = stripslashes($row['user_pass']);
}
else
{
	echo "找不到";
...
if($wp_hasher->CheckPassword($passwd, $userpasswd)){ 
